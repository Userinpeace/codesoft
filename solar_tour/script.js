const model = [
  ...
  },
  {
    name: "SATURN",
    description:
      "Saturn is the sixth planet from the Sun and the second-largest in the Solar System. It is known for its extensive ring system, which is made of ice particles and dust.",
    year: "4.5 billion",
    type: "gas giant",
    radius: "58,232 km",
    planet: "./images/saturn.png", 
    galaxy: "./images/galaxy5.jpg", 
  },
];
...
// Function to update planet info
const updatePlanetInfo = () => {
  ...
  galaxy.style.transform = `rotate(-${degrees}deg) scale(2)`;
  setTimeout(() => {
...
// Right button functionality with looping
...
// Left button functionality with looping
